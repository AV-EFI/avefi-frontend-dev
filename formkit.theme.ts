...
/**
  ...
  * @variables - radius=rounded-xl,accentColor=primary,colorTemperature=zinc,spacing=1.5,scale=sm,inputShadow=shadow-sm,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=300,inputMaxWidth=max-w-[20em],tagRadius=rounded-none,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-primary-400": true,
    "peer-checked:border-primary-500": true,
    "relative": true,
    "block": true,
    "text-base": true,
    "w-[1em]": true,
    ...
    "peer-checked:text-primary-500": true,
    ...
    "dark:ring-offset-primary-400": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-zinc-600/50": true,
    "dark:peer-checked:bg-primary-800": true,
    "dark:peer-checked:text-primary-300": true
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-primary-400": true,
    "focus-within:!border-primary-400": true,
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-primary-400": true,
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "cursor-pointer": true,
    "dark:text-zinc-200": true,
    "dark:hover:text-primary-400": true
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-primary-300": true,
  ...
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-primary-100": true
  },
  "file__fileList": {
    "group/list": true,
    "peer": true,
  ...
  "file__fileRemove": {
    ...
    "peer-data-[has-multiple]:text-primary-500": true,
  ...
  "form__messageLink": {
    ...
    "group-[]/summary:ring-primary-500": true
  },
  "month__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "[&::-webkit-slider-thumb]:bg-primary-500": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-primary-400": true,
    ...
    "[&::-moz-range-thumb]:bg-primary-500": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-primary-400": true,
  ...
  "select__option": {
    ...
    "group-data-[multiple]:px-1.5": true,
    "dark:group-data-[multiple]:focus:bg-primary-700": true,
    "dark:group-data-[multiple]:checked:bg-primary-700": true
  },
  "select__prefixIcon": {
    "flex": true,
    "items-center": true,
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input:focus]:ring-primary-500": true,
    "[&>input:focus]:border-primary-500": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas:focus-visible]:ring-primary-400": true,
  ...
  "datepicker__month": {
    ...
    "focus:outline-primary-500": true,
  ...
  "datepicker__dayCell": {
    ...
    "dark:bg-zinc-600": true,
    "dark:text-zinc-300": true,
    "dark:aria-selected:bg-primary-500": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-primary-500": true,
  ...
  "datepicker__timeInput": {
    ...
    "p-1.5": true,
    "my-2": true,
    "focus-visible:outline-primary-500": true,
    "dark:text-zinc-300": true,
    "dark:bg-transparent": true,
    "dark:border-zinc-400": true
  },
  ...
  "datepicker__dayButton": {
    ...
    "dark:text-zinc-300": true,
    "dark:border-zinc-400": true,
    "dark:hover:border-primary-400": true
  },
  ...
  "datepicker__calendarIcon": {
    "text-zinc-600": true,
    "focus-visible:text-primary-500": true,
    "flex": true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  "slider__tooltip": {
    ...
    "after:border-t-primary-500": true,
  ...
  "toggle__track": {
    ...
    "shadow-none": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-primary-400": true,
  ...
  "togglebuttons__input": {
    ...
    "dark:text-primary-500": true,
    "aria-[pressed=true]:bg-primary-500": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-primary-500": true,
    ...
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-primary-500": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-primary-500": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-primary-500": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-primary-500": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-primary-500": true,
    ...
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-primary-500": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-primary-500": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-primary-500": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-primary-500": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-primary-500": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
    ...
    "text-sm": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-primary-500": true,
  ...
  "transferlist__transferlist": {
    ...
    "[&:has(:focus-visible)]:ring-primary-400": true,
    "dark:border-zinc-400": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "data-[is-active=true]:bg-primary-100": true,
    "data-[is-active=true]:ring-primary-200": true,
    "aria-selected:ring-primary-200": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-zinc-800": true,
    "dark:text-zinc-300": true,
    "dark:data-[is-active=true]:bg-primary-800": true,
    "dark:aria-selected:bg-primary-800": true,
    "dark:ring-zinc-500": true,
    "dark:data-[is-active=true]:ring-primary-500": true,
    "dark:aria-selected:ring-primary-500": true,
    "[&.formkit-dropZone]:bg-primary-100": true,
    "[&.formkit-selectionDropZone]:bg-primary-100": true,
    "[&.formkit-touchDropZone]:bg-primary-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-primary-100": true,
    "[&.formkit-longTouch]:bg-primary-100": true,
    "dark:[&.formkit-dropZone]:bg-primary-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-primary-900": true,
    "dark:[&.formkit-touchDropZone]:bg-primary-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-primary-900": true,
    "dark:[&.formkit-longTouch]:bg-primary-900": true
  },
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=\"progress\"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-primary-500": true,
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-primary-500": true
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-primary-500": true,
