...
export function toMovingImageRecord(o: MovingImageRecord): MovingImageRecord {
    return {
        described_by: o.described_by ?? undefined,
...
export interface DescriptionResource {
    /** Link to revision history of this PID */
    has_history?: string,
...
export function toDescriptionResource(o: DescriptionResource): DescriptionResource {
    return {
        has_history: o.has_history ?? undefined,
        has_issuer_id: o.has_issuer_id ?? undefined,
        has_issuer_name: o.has_issuer_name ?? '',
        last_modified: o.last_modified ?? undefined
    }
}
...
export function toWorkVariant(o: WorkVariant): WorkVariant {
    return {
        ...
        variant_type: o.variant_type ?? undefined,
        described_by: o.described_by ?? undefined,
        has_event: o.has_event ?? [],
        in_language: o.in_language ?? [],
        has_alternative_title: o.has_alternative_title ?? [],
...
export function toManifestationOrItem(o: ManifestationOrItem): ManifestationOrItem {
    return {
        ...
        has_note: o.has_note ?? [],
        has_webresource: o.has_webresource ?? undefined,
        described_by: o.described_by ?? undefined,
        has_event: o.has_event ?? [],
        in_language: o.in_language ?? [],
        has_alternative_title: o.has_alternative_title ?? [],
...
export function toDuration(o: Duration): Duration {
    return {
        ...
        has_precision: o.has_precision ?? undefined,
        category: o.category ?? undefined
    }
}
...
export function toExtent(o: Extent): Extent {
    return {
        has_unit: o.has_unit ?? undefined,
        has_value: o.has_value ?? undefined,
        has_precision: o.has_precision ?? undefined,
        category: o.category ?? undefined
    }
}
...
export function toManifestation(o: Manifestation): Manifestation {
    return {
        has_colour_type: o.has_colour_type ?? undefined,
        has_item: o.has_item ?? [],
        has_sound_type: o.has_sound_type ?? undefined,
...
export function toItem(o: Item): Item {
    return {
        ...
        has_access_status: o.has_access_status ?? undefined,
