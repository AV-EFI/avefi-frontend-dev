  ...
  <article class="search-result">
    ...
    <div class="search-result__body">
      ...
      <div class="search-result__data">
        ...
        <div v-if="result.race">
          Race: {{ result.race.raw }}
        </div>
        ...
        <br>
        <div v-if="result.cost">
          Cost: {{ result.cost.raw }}
        </div>
        <div v-if="result.attack">
          Attack: {{ result.attack.raw }}
        </div>
        <div v-if="result.durability">
          Durability: {{ result.durability.raw }}
        </div>
        <div v-if="result.health">
          Health: {{ result.health.raw }}
        </div>
        <div v-if="result.armor">
          Armor: {{ result.armor.raw }}
        </div>
        <div v-if="result.spell_damage">
          Spell damage: {{ result.spell_damage.raw }}
        </div>
        <div v-if="result.overload">
          Overload: {{ result.overload.raw }}
        </div>
        <br>
        <div v-if="result.artist">
          Artist: {{ result.artist.raw }}
        </div>
      </div>
    </div>
    <p class="search-result__flavor">
      {{ result.flavor.raw }}
    </p>
  </article>
</template>
